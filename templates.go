...
/* CORRECAO MENU UNICO */
.topo-sistema {
	background: linear-gradient(135deg, #1f7a4d, #145c38) !important;
	color: white !important;
...
<div class="topo-sistema">
	<div class="topo-conteudo">
		<strong>Checklist Rural</strong>
		<nav>
			<a href="/">Início</a>
			<a href="/nova-reuniao">Nova reunião</a>
			<a href="/reunioes">Reuniões</a>
			<a href="/consultas-externas">Consultas</a>
			<a href="/pastas">Pastas</a>
			<a href="/backup">Backup</a>
			<a href="/configuracoes-api">Configurações</a>
		</nav>
	</div>
</div>
